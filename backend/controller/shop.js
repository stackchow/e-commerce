...
// log out from shop
const shopLogout = catchAsyncErrors(async (req, res, next) => {
  try {
...
const adminGetAllSellers = catchAsyncErrors(async (req, res, next) => {
  try {
...
// delete seller ---admin
const deleteSellerById = catchAsyncErrors(async (req, res, next) => {
  try {
